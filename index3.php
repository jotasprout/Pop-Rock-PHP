...
<th onClick="sortColumn('followers', 'DESC')"><div class="pointyHead rightNum">Spotify<br>Followers</div></th>
<th onClick="sortColumn('datadate', 'DESC')"><div class="pointyHead rightNum">LastFM<br>Data Date</div></th>
<th onClick="sortColumn('listeners', 'DESC')"><div class="pointyHead rightNum">LastFM<br>Listeners</div></th>
<th onClick="sortColumn('playcount', 'DESC')"><div class="pointyHead rightNum">LastFM<br>Playcount</div></th>
</tr>
	</thead>
	...
	<script src="https://www.roxorsoxor.com/poprock/functions/sort_Artists3.js"></script>
