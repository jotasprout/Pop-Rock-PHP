...
$.getJSON("getGenresFromDB.php", function (genresData2) {
    ...
    */
    ...
    for (let i = 0; i < thesePeople.length; i++) {
        ...
        $genresBarsBaseURL = 'https://www.roxorsoxor.com/poprock/genres/genreArtists_popCurrentBars.php?artistGenre=';
        $chosenGenre = person.genre;
        $fullGenresURL = $genresBarsBaseURL + $chosenGenre;
        $row.append($('<td></td>').append($("<a href='" + $fullGenresURL + "'></a>").text(person.genre)));
